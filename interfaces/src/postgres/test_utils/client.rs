...
impl<D> PostgresTestClient<D>
where
    D: PostgresTestDBMS + 'static
{
    pub fn new_from_db(client: PostgresClient<D>) -> Self {
        Self { client }
    }
...
impl<D> Database for PostgresTestClient<D>
where
    D: PostgresTestDBMS + 'static
{
    type DBMS = D;
...
impl<D> TestDatabase<D> for PostgresTestClient<D>
where
    D: PostgresTestDBMS + 'static
{
