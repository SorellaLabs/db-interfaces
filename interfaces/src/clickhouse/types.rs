...
pub trait ClickhouseInsert:
    Serialize + InsertRow + Send + Sync + 'static + DynClone + Sized
{
}
impl<T> ClickhouseInsert for T where
    T: Serialize + InsertRow + Send + Sync + 'static + DynClone + Sized
{
}
