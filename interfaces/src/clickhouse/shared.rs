...
use crate::{errors::DatabaseError, BindClickhouseParameters, Database, DatabaseTable};
    ...
    D: ClickhouseDBMS
{
    ...
    async fn query_one<Q: ClickhouseQuery, P: BindClickhouseParameters>(&self, query: impl AsRef<str> + Send, params: P) -> Result<Q, DatabaseError> {
